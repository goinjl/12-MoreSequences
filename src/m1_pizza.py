...
def run_test_generate_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    expected = [rg.Point(425.0, 40.0),  # All numbers are approximate.
                rg.Point(272.5, 304.1),
                rg.Point(-32.5, 304.1),
                rg.Point(-185.0, 40.0),
                rg.Point(-32.5, -224.1),
                rg.Point(272.5, -224.1)]
    circle = rg.Circle(rg.Point(120, 40), 305)
    answer = generate_points_on_circle(circle, 6)
...
def run_test_draw_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    title = 'DRAW_POINTS_ON_CIRCLE, test 3:  12 purple dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(100, 100), 50)
    draw_points_on_circle(window, circle, 12, 'purple')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    title = 'PIZZA test 4:  80 slices, thin (thickness=1) black lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 3
...
def run_test_polygon():
    ...
    polygon(window, circle, 7, 'yellow', 10)
    window.close_on_mouse_click()
